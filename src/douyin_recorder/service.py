...
from .errors import DouyinFetchError, FFmpegRecordingError, SourceUnavailableError
...
class DouyinRecordingService:
    def __init__(self, client: DouyinClient, recorder: Recorder) -> None:
        self.client = client
